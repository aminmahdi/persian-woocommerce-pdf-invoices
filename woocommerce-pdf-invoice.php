...
if (!class_exists('WooPDF')) {
    ...
    class WooPDF
    {
        ...
        public function on_plugins_loaded()
        {
            ...
            RightPress_Updates::init(__FILE__, WOOPDF_VERSION);
            ...
            if ($this->opt['woo_pdf_enabled'] || $this->opt['woo_pdf_proforma_enabled']) {
                ...
                add_action('woocommerce_payment_complete', array($this, 'process_completed'), 1);
        ...
        public function send_by_email($attachments, $email_type = null, $order = null)
        {
            ...
            if ($email_type == 'customer_invoice') {
                ...
                $invoice_id = self::get_invoice_meta($order->id, 'woo_pdf_invoice_id');
